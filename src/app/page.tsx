    ...
    <main className="flex flex-col items-center overflow-x-hidden">
      ...
      <section className="w-full max-w-4xl mx-auto px-6 pt-28 pb-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            href="mailto:denver@madebyplume.com?subject=Murmur%20Bug%20Report&body=Version%3A%201.3.005%0A%0AWhat%20happened%3A%0A%0ASteps%20to%20reproduce%3A"
